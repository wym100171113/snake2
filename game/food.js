...
export const FOOD_TYPES = {
    ...
    sushi:     { key:'sushi',name:'寿司',emoji:'🍣',color:'#FF8A65',score:22,growth:3,radius:15,lifespan:10000,weight:7,buff:{type:'magnet',duration:8000,radius:150},tier:'rare',desc:'新鲜寿司，磁力吸引8秒'},
    ...
    oyster:    { key:'oyster',name:'牡蛎',emoji:'🦪',color:'#B0BEC5',score:28,growth:4,radius:16,lifespan:10000,weight:6,buff:{type:'fat',duration:20000},tier:'rare',desc:'新鲜牡蛎，变粗20秒'},
    ...
    donut:     { key:'donut',name:'甜甜圈',emoji:'🍩',color:'#FF80AB',score:45,growth:4,radius:17,lifespan:8000,weight:4,buff:{type:'superSpeed',duration:10000,factor:3},tier:'epic',desc:'甜甜圈，10秒3倍速！'},
    ...
    taco:      { key:'taco',name:'墨西哥卷',emoji:'🌮',color:'#FFCC80',score:45,growth:4,radius:17,lifespan:8000,weight:4,buff:{type:'magnet',duration:6000,radius:150},tier:'epic',desc:'墨西哥卷，磁力吸引6秒'},
    ...
    curry:     { key:'curry',name:'咖喱饭',emoji:'🍛',color:'#FFB74D',score:65,growth:5,radius:19,lifespan:7500,weight:3,buff:{type:'doubleScore',duration:15000},tier:'epic',desc:'香辣咖喱饭，双倍积分15秒'},
    bento:     { key:'bento',name:'便当',emoji:'🍱',color:'#FF8A65',score:55,growth:5,radius:18,lifespan:8000,weight:4,buff:{type:'fat',duration:20000},tier:'epic',desc:'精美便当，变粗20秒'},
    spaghetti: { key:'spaghetti',name:'意大利面',emoji:'🍝',color:'#FFCC80',score:50,growth:5,radius:18,lifespan:8000,weight:4,buff:{type:'slow',factor:0.35,duration:8000},tier:'epic',desc:'意大利面，大幅减速8秒'},
    // ── 传奇 ──
